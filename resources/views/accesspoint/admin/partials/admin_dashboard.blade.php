        ...
        <div class="row gy-4">
            ...
            <div class="col-md-12 col-lg-4">
                <div class="card">
                    ...
                    <img src="{{ asset('assets/admin/img/icons/misc/triangle-light.png') }}"
                    ...
                    <img src="{{ asset('assets/admin/img/illustrations/trophy.png') }}"
                        ...
                        <ul class="p-0 m-0">
                            <li class="d-flex mb-4 pb-md-2">
                                <div class="avatar flex-shrink-0 me-3">
                                    <img src="{{ asset('assets/admin/img/icons/misc/zipcar.png') }}" alt="zipcar"
                                        class="rounded" />
                                </div>
                            ...
                            <li class="d-flex mb-4 pb-md-2">
                                <div class="avatar flex-shrink-0 me-3">
                                    <img src="{{ asset('assets/admin/img/icons/misc/bitbank.png') }}" alt="bitbank"
                                        class="rounded" />
                                </div>
                                <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
                                    <div class="me-2">
                            ...
                            <li class="d-flex mb-md-3">
                                <div class="avatar flex-shrink-0 me-3">
                                    <img src="{{ asset('assets/admin/img/icons/misc/aviato.png') }}" alt="aviato"
                                        class="rounded" />
                                </div>
                                <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
                                    <div class="me-2">
                                ...
                                <ul class="p-0 m-0">
                                    <li class="d-flex mb-4 align-items-center pb-2">
                                        <div class="flex-shrink-0 me-3">
                                            <img src="{{ asset('assets/admin/img/icons/payments/gumroad.png') }}"
                                    ...
                                    <li class="d-flex mb-4 align-items-center pb-2">
                                        <div class="flex-shrink-0 me-3">
                                            <img src="{{ asset('assets/admin/img/icons/payments/mastercard-2.png') }}"
                                    ...
                                    <li class="d-flex mb-4 align-items-center pb-2">
                                        <div class="flex-shrink-0 me-3">
                                            <img src="{{ asset('assets/admin/img/icons/payments/stripes.png') }}"
                                    ...
                                    <li class="d-flex mb-4 align-items-center pb-2">
                                        <div class="flex-shrink-0 me-3">
                                            <img src="{{ asset('assets/admin/img/icons/payments/american-bank.png') }}"
                                    ...
                                    <li class="d-flex align-items-center">
                                        <div class="flex-shrink-0 me-3">
                                            <img src="{{ asset('assets/admin/img/icons/payments/citi.png') }}"
                        ...
                        <div class="col-12 col-md-6 ps-0 ps-md-3 mt-3 mt-md-2">
                            ...
                            <div class="pt-2">
                                <ul class="p-0 m-0">
                                    <li class="d-flex mb-4 align-items-center pb-2">
                                        <div class="flex-shrink-0 me-3">
                                            <img src="{{ asset('assets/admin/img/icons/brands/google.png') }}"
                                    ...
                                    <li class="d-flex mb-4 align-items-center pb-2">
                                        <div class="flex-shrink-0 me-3">
                                            <img src="{{ asset('assets/admin/img/icons/brands/github.png') }}"
                                    ...
                                    <li class="d-flex mb-4 align-items-center pb-2">
                                        <div class="flex-shrink-0 me-3">
                                            <img src="{{ asset('assets/admin/img/icons/brands/slack.png') }}"
                                    ...
                                    <li class="d-flex mb-4 align-items-center pb-2">
                                        <div class="flex-shrink-0 me-3">
                                            <img src="{{ asset('assets/admin/img/icons/payments/digital-ocean.png') }}"
                                    ...
                                    <li class="d-flex align-items-center">
                                        <div class="flex-shrink-0 me-3">
                                            <img src="{{ asset('assets/admin/img/icons/brands/aws.png') }}"
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <div class="avatar avatar-sm me-3">
                                                <img src="{{ asset('assets/admin/img/avatars/3.png') }}" alt="Avatar"
                                                    class="rounded-circle" />
                                            </div>
                                            <div>
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <div class="avatar avatar-sm me-3">
                                                <img src="{{ asset('assets/admin/img/avatars/2.png') }}" alt="Avatar"
                                                    class="rounded-circle" />
                                            </div>
                                            <div>
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <div class="avatar avatar-sm me-3">
                                                <img src="{{ asset('assets/admin/img/avatars/5.png') }}" alt="Avatar"
                                                    class="rounded-circle" />
                                            </div>
                                            <div>
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <div class="avatar avatar-sm me-3">
                                                <img src="{{ asset('assets/admin/img/avatars/7.png') }}" alt="Avatar"
                                                    class="rounded-circle" />
                                            </div>
                                            <div>
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <div class="avatar avatar-sm me-3">
                                                <img src="{{ asset('assets/admin/img/avatars/6.png') }}" alt="Avatar"
                                                    class="rounded-circle" />
                                            </div>
                                            <div>

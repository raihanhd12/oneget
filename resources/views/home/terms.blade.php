...
@section('content')
    <section id="contactus" class="contactus">
        ...
        <div class="row body d-flex">
            <div class="col-3 links">
                <div class="mb-2">
                    <a class="link" href="#section-1">Definition</a>
                </div>
                <div class="mb-2">
                    <a class="link" href="#section-2">Acknowledgment</a>
                </div>
                <div class="mb-2">
                    <a class="link" href="#section-3">Links to Other Websites</a>
                </div>
                <div class="mb-2">
                    <a class="link" href="#section-4">Limitation of Liability</a>
                </div>
                <div class="mb-2">
                    <a class="link" href="#section-5">"AS IS" and "AS AVAILABLE" Disclaimer</a>
                </div>
                <div class="mb-2">
                    <a class="link" href="#section-6">Governing Law</a>
                </div>
                <div class="mb-2">
                    <a class="link" href="#section-7">Severability and Waiver</a>
                </div>
            ...
            <div class="col terms">
                ...
                <div id="section-1">
                    ...
                    <ul type="circle">
                        ...
                        <li><strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this
                            Agreement) refers to
                            PT Adma Digital Solusi, Gunawangsa Merr Office Tower A 3rd Floor OA 307-311 Jl. Kedung Baruk 96,
                            Kota Surabaya - 60298 .
                        </li>
                        ...
                        <li><strong>Website</strong> refers to Oneget, accessible from <a
                                href="oneget.adslink.id">oneget.adslink.id</a></li>
                ...
                <div id="section-2">
                    ...
                    <p>You represent that you are over the age of 13. The Company does not permit those under 13 to use the
                        Service.</p>
                ...
                <div id="section-7">
                    ...
                    <ul type="circle">
                        <li>By email: official.oneget@gmail.com</li>
                        <li>By visiting this page on our website: <a href="oneget.adslink.id">oneget.adslink.id</a></li>
                    </ul>
                </div>
            </div>
        </div>
    ...
    <script>
        // Mendapatkan referensi ke tombol "Back to Top"
        var backToTopButton = document.getElementById('back-to-top');

        // Munculkan tombol ketika pengguna bergulir ke bawah sejauh 300px dari atas halaman
        ...
        // Menggerakkan halaman ke atas saat tombol diklik
        backToTopButton.addEventListener('click', function() {
            // Gulir ke atas dengan animasi lembut
            window.scrollTo({
                top: 0,
                behavior: 'smooth'
            });
